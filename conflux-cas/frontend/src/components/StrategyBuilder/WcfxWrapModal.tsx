...
export function WcfxWrapModal({
    ...
    const wcfxAddr = wcfxAddress(chainId.toString());
                    ...
                    <div className="flex gap-2 p-1 bg-slate-950 rounded-xl border border-slate-800">
                        {(['wrap', 'unwrap'] as const).map((tab) => (
                            <button
                                ...
                                className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all ${wcfxPanelTab === tab
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="text-slate-500 font-medium">
                                Available:{' '}
                                <span className={wcfxPanelTab === 'wrap' ? 'text-white' : 'text-conflux-400'}>
                                    {wcfxPanelTab === 'wrap'
